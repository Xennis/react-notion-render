...
export const PageTitle = ({ icon, children }: { icon: IconResponse; children: React.ReactNode }) => {
  ...
  return (
    ...
    <span className="inline-flex max-w-full items-center">
      ...
      <Icon icon={icon} width={18} className="me-1.5 ms-0.5 flex shrink-0 justify-center rounded-sm" />
      ...
      <span className="decoration-(--fg-color-2) overflow-hidden text-ellipsis whitespace-nowrap underline underline-offset-2 hover:no-underline">
        {children}
      </span>
    </span>
  )
